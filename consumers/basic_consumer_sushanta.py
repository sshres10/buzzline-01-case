...
Read a log file as it is being written and alert on Arsenal FC-related messages.
"""
...
def process_message(log_file) -> None:
    ...
    with open(log_file, "r") as file:
        ...
        while True:
            ...
            # Monitor and alert on Arsenal FC-related messages
            if "Arsenal FC" in message:
                print(f"ALERT: Arsenal FC mention found! \n{message}")
                logger.warning(f"ALERT: Arsenal FC mention found! \n{message}")
